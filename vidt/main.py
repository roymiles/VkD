...
def main(args):
    ...
    # add projections [manual]
    model.has_projections = True
    model.patch_projector_1 = OrthogonalLinear(256, 256)
    model.patch_projector_2 = OrthogonalLinear(256, 256)
    model.patch_projector_3 = OrthogonalLinear(256, 256)
    model.patch_projector_4 = OrthogonalLinear(256, 256)
    model.neck_det_projector = OrthogonalLinear(256, 256)
    model.body_det_projector = OrthogonalLinear(256, 256)
    ...
    if args.distil_model is not None:
        ...
        teacher_model.has_projections = False
